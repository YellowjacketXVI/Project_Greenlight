"""
Agnostic_Core_OS OmniMind Memory System

Memory management for the OmniMind context library.
Provides short-term, long-term, and preference-based memory storage.
"""
...
logger = logging.getLogger("agnostic_core_os.omni_mind.memory")
...
class Memory:
    """
    Memory system for OmniMind.

    Features:
    - Short-term conversation memory (FIFO with limit)
    - Long-term project memory (importance-based retention)
    - User preference tracking
    - Decision history
    - Importance-based retention and eviction
    """
    ...
    def get_by_type(self, memory_type: MemoryType, limit: int = 20) -> List[MemoryEntry]:
